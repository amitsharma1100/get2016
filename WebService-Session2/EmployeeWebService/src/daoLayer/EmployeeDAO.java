...
public class EmployeeDAO {
    ...
    public int addEmployee(Employee employee) {
        ...
        String sqlQuery = "INSERT INTO employeeinfo (ID,EmployeeName,EmployeeAge) " + "Values (? , ? , ? );";
        int result = 0;
    ...
    public List < Employee > selectEmployeeBasedOnID(String employeeID) {
        ...
        String sqlQuery = "SELECT ID,EmployeeName,EmployeeAge FROM employeeinfo " + "WHERE ID = ?;";
        PreparedStatement prepareStatement = null;
    ...
    public List < Employee > selectEmployeeBasedOnName(String employeeName) {
        String sqlQuery = "SELECT ID,EmployeeName,EmployeeAge FROM employeeinfo " + "WHERE EmployeeName = ?;";
        PreparedStatement prepareStatement = null;
        List < Employee > listOfEmployee = null;
        try {

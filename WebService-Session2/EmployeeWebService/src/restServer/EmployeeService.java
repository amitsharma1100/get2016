...
public class EmployeeService {
    ...
    @
    GET@ Path("/getAllEmployees")@ Produces("application/json")
    ...
    @
    POST@ Path("/addEmployee")@ Produces(MediaType.TEXT_PLAIN)@ Consumes(MediaType.TEXT_PLAIN)
    ...
    @
    POST@ Path("/getEmployeeById")@ Produces("application/json")@ Consumes(MediaType.TEXT_PLAIN)
    ...
    @
    POST@ Path("/getEmployeeByName")@ Produces("application/json")@ Consumes(MediaType.TEXT_PLAIN)
    ...
    @
    POST@ Path("/deleteEmployeeById")@ Produces(MediaType.TEXT_PLAIN)@ Consumes(MediaType.TEXT_PLAIN)

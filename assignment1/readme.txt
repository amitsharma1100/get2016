...
Q2: If the above created list is list1 then add another list list2 to the first list. So the resultant list list1 must contain
now all the elements of its own list and in addition to the elements contained in list2.

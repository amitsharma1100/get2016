...
/**
 * Servlet implementation class SearchCarServlet searches the car based on
 * various parameters
 */
...
public class SearchCarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		case "model":
			...
			break;
		// if the search is to be performed on the basis of
		// engine,fuel,milage,price
		// then parse the value of above parameters
		case "engine":
		case "fuel-capacity":
		case "milage":
		case "price":
			int minValue = Integer.parseInt(request
					.getParameter("search-value-number-min"));
			int maxValue = Integer.parseInt(request
					.getParameter("search-value-number-max"));
